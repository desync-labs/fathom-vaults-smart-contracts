...
contract MockTokenizedStrategy is TokenizedStrategy {
    ...
    constructor(address _asset, string memory _name, address _management, address _keeper, uint32 _profitMaxUnlockTime, address _factory) TokenizedStrategy(_factory) {
