...
interface ITradeFintechStrategyEvents {
    ...
    /// @notice Emits when funds are returned to the strategy by the manager
    ...
    /// @notice Emits when funds are locked
    /// @param sender The address that locked the funds
